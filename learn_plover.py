# This file contains the words that occur in the "Learn Plover" series, grouped by lesson.
# Taken from https://github.com/JoshuaGrams/steno-jig.

learn_plover_lessons = [
    "One Syllable Words",
    "Consonant Clusters",
    "Where's the TRUFT?",
...
learn_plover_lesson_words = {"One Syllable Words": [
